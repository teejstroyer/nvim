...
vim.keymap.set("n", "<leader><space>", ":FzfLua<CR>", { desc = "FZF Lua" })                           -- A general-purpose fzf command.
...
vim.keymap.set("n", "<leader>fg", fzf.grep, { desc = "Find grep" })                                   -- Search for a string in all files in the project.
